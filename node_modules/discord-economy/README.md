...
-   [1.1.6](https://www.npmjs.com/package/discord-economy/v/1.1.6) The Leaderboard function now has a filter function, some example bot typos got fixed. And the Leaderboard overall works again normally!!
